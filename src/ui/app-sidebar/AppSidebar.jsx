...
const AppSidebar = ({ isShort, setIsShort, isRight, children }) => {
  ...
  let appSidebar =
    isRight && isShort
      ? "app-sidebar-right app-sidebar-right_short"
      : isRight && !isShort
      ? "app-sidebar-right app-sidebar-right_long"
      : !isRight && isShort
      ? "app-sidebar app-sidebar_short"
    ...
    <aside className={appSidebar}>
      {!isRight ? (
        ...
        <div className="app-sidebar-right__head">
          ...
          >
            <div
              className={`app-sidebar-right__head-btn-icon align-center ${
                isShort && "app-sidebar-right__head-btn-icon_flipped"
              }`}
            >
              <AppIcon
          ...
          {!isShort && (
            <div className="app-sidebar-right__head-params">
              ...
              >
                <AppText text="Свернуть все" lineHeight={24} color="#2662C9" />
              </button>
            </div>
          )}
        </div>
