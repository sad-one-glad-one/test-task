...
const DataTable = () => {
  ...
  const isAccendingNameClass =
    sortableTitle[0].direction === "ascending"
      ? "table-th__sortable_asc"
      : "table-th__sortable_desc"
  const isAccendingPriceClass =
    sortableTitle[1].direction === "ascending"
      ? "table-th__sortable_asc"
      : "table-th__sortable_desc"
          ...
          <tr>
            ...
            >
              ...
              <AppIcon
                ...
                height="24"
                color={
                  sortableTitle[0].isActive ? "#2662C9" : "rgba(0, 0, 0, 0.16)"
                }
              />
            </th>
            <th>
            ...
            >
              ...
              <AppIcon
                ...
                height="24"
                color={
                  sortableTitle[1].isActive ? "#2662C9" : "rgba(0, 0, 0, 0.16)"
                }
              />
            </th>
            <th></th>
          ...
          {data?.map((item) => (
            <tr key={item?.GoodsCommercialName}>
              <td className="table__product">
                ...
                <AppText text={item?.GoodsCommercialName} lineHeight={24} />
              </td>
              ...
              <td>
                <AppButton
                  text={"Добавить"}
                  onClick={() => dispatch(openModalAction(item))}
                />
              </td>
            </tr>
          ))}
