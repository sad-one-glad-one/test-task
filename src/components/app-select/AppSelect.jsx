...
const AppSelect = ({ label, options, selectedOption, setSelectedOption }) => {
  ...
  return (
    <div className="app-select" ref={selectRef}>
      ...
      <button className="app-select__btn" onClick={() => toggleSelect()}>
        <AppText text={selectedOption} />
        <div
          className={`app-select__btn-icon align-center ${
            isOpen ? flippedChevronClass : ""
          }`}
        >
          <AppIcon
